...
import 'package:tua/core/utils/screen_spaces_extension.dart';
    ...
    return InkWell(
      ...
      child: Row(
        children: [
          ...
          if (widget.child == null) Expanded(child: Text(widget.textValue ?? '', style: Styles.style12400.copyWith(color: AppColors.subTextColor))),
        ],
      ),
    );
  }
