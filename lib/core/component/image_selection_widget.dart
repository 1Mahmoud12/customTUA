  ...
  Widget build(BuildContext context) {
    return selectedImage == null
        ? Container(
          ...
          child: InkWell(onTap: selectImage, child: SvgPicture.asset(AppIcons.uploadFileImageIc, fit: BoxFit.fitWidth, width: context.screenWidth)),
        )
        : Stack(
          children: [
            Container(
              ...
              width: context.screenWidth,
              height: 100,
              decoration: BoxDecoration(image: DecorationImage(image: FileImage(selectedImage!), fit: BoxFit.fill)),
            ),
            Positioned(
              top: 8,
              right: 8,
