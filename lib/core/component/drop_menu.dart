...
import 'package:tua/core/component/custom_drop_down_menu.dart' show DropDownModel;
        ...
        children: [
                    ...
                    return widget.items.map((DropDownModel item) {
                      return PopupMenuItem<DropDownModel>(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(border: Border(bottom: BorderSide(color: AppColors.black.withAlpha((.2 * 255).toInt())))),
                        ...
                        if (newSelected.showName)
                          Padding(
                            ...
                            child: Text(
                              newSelected.name.tr(),
                              style:
                                  widget.textStyleSelected?.copyWith(color: AppColors.textColor, fontWeight: FontWeight.w400) ??
                                  Styles.style14400.copyWith(
                                    color:
                                        (newSelected.name.contains('DD/') || newSelected.name.contains('select'))
                                            ? AppColors.greyG900
                                            : AppColors.textColor,
          ...
          if (widget.hasError && widget.errorText != null)
            Padding(
              ...
              child: Text(widget.errorText!.tr(), style: TextStyle(color: Colors.red, fontSize: Constants.tablet ? 12 : 12.sp)),
            ),
        ],
      ),
    );
