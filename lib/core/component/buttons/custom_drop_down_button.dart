            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  hint: Text(widget.hint != null ? widget.hint! : '', style: TextStyle(color: Colors.grey, fontSize: dropdownTextSize)),
                  items:
                      widget.items.map((String item) {
                        return DropdownMenuItem<String>(
                          value: item,
                          child: Text(item, style: TextStyle(color: Colors.black, fontSize: dropdownTextSize)),
                        );
                      }).toList(),
                  onChanged: (value) {
                    setState(() {
