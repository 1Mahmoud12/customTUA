...
void customShowToast(
  ...
  final OverlayEntry entry = OverlayEntry(
    builder:
        (context) => BottomToastOverlayContainer(
          message: message,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return PositionedDirectional(
          ...
          top:
              widget.showToastPosition == ShowToastPosition.top
          ...
          bottom:
              widget.showToastPosition == ShowToastPosition.bottom
            ...
            child: Material(
              ...
              child: switch (widget.showToastStatus) {
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(widget.message, style: Styles.style14500.copyWith(color: AppColors.white), textAlign: TextAlign.center),
                          ),
                        ],
                      ),
                    ),
                ...
                ShowToastStatus.error => Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: Text(widget.message, style: Styles.style14500.copyWith(color: AppColors.white), textAlign: TextAlign.center)),
                    ],
                  ),
                ),
              },
