...
class Constants {
  static String fontFamily = 'Alexandria';
...
List<Country> countries = [
  Country(id: 1, name: 'egy', code: '20', image: AppIcons.egyptFlag),
  Country(id: 2, name: 'sau', code: '966', image: AppIcons.saudiArabiaFlag),
  Country(id: 3, name: 'ema', code: '973', image: AppIcons.emiratesFlag),
];
List<PricingModel> pricingModel = [PricingModel(id: 1, name: 'egy'), PricingModel(id: 2, name: 'sau'), PricingModel(id: 3, name: 'ema')];
