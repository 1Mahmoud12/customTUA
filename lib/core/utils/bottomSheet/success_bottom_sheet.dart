...
import 'package:tua/core/utils/item_above_modal_bottom_sheet.dart';
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      AnimatedContainer(
                        ...
                        child: Center(child: Icon(Icons.check, color: AppColors.white, size: expanded ? 100 : 25)),
                      ),
                      const SizedBox(height: 12),
                      Text(widget.title.tr(), textAlign: TextAlign.center, style: Styles.style18300.copyWith(fontWeight: FontWeight.w500)),
