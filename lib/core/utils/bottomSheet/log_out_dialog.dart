...
Future<void> logOutDialog({required BuildContext context, required void Function()? onPress}) async {
  showDialog(
    context: context,
      ...
      return StatefulBuilder(
        builder:
            (context, setState) => SpringAnimationDialog(
              dialog: AlertDialog(
                title: Column(children: [Image.asset(AppImages.logout, fit: BoxFit.contain, width: 90, height: 90)]),
                content: Text(
                  'are_you_sure_you_want_to_log_out_of_your_account?'.tr(),
