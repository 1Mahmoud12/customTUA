        ...
        (context) => AlertDialog(
          ...
          title: Column(
            children: [
              ...
              Text(name.tr(), textAlign: TextAlign.center, style: Styles.style18300.copyWith(fontWeight: FontWeight.w500)),
      ...
      child: Stack(
        children: <Widget>[
          ...
          Container(
            ...
            child: const Align(
              child: Column(children: [Text('Dialog Title!', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600))]),
            ),
          ),
          Align(
            alignment: Alignment.bottomCenter,
            child: InkWell(
              ...
              child: Container(
                ...
                child: const Align(child: Text("Okay let's go!", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600))),
              ),
            ),
          ),
          Align(
