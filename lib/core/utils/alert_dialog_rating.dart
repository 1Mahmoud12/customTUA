...
import 'package:tua/core/utils/custom_alert_dialog.dart';
import 'package:tua/core/utils/extensions.dart';

Future<void> alertDialogRating(BuildContext context, {required String nameRequest}) async {
  showDialog(
    context: context,
    builder:
        (context) => AlertDialog(
            ...
            children: [
              Text.rich(
                TextSpan(
                  ...
                  children: [
                    TextSpan(text: '"', style: Styles.style18300.copyWith(fontWeight: FontWeight.w500, fontFamily: Constants.fontFamily)),
                    TextSpan(
                      text: nameRequest.tr(),
                      style: Styles.style18300.copyWith(fontWeight: FontWeight.w500, fontFamily: Constants.fontFamily),
                    ),
