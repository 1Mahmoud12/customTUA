...
class HumanitarianAidWidget extends StatelessWidget {
  const HumanitarianAidWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        SeeAllWidget(title: 'humanitarian_aid'.tr()),
        const SizedBox(height: 16),
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Row(children: [...List.generate(3, (index) => const ItemHumanitarianAidWidget())]),
        ),
      ],
    );
  }
...
class ItemHumanitarianAidWidget extends StatefulWidget {
  const ItemHumanitarianAidWidget({super.key});

  @override
  State<ItemHumanitarianAidWidget> createState() => _ItemHumanitarianAidWidgetState();
}

class _ItemHumanitarianAidWidgetState extends State<ItemHumanitarianAidWidget> {
  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
                    ...
                    children: [
                      Flexible(
                        child: Container(
                          ...
                          decoration: BoxDecoration(color: AppColors.cHumanitarianAidColor, borderRadius: BorderRadius.circular(8)),
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              SvgPicture.asset(AppIcons.humanitarianAidIc, colorFilter: const ColorFilter.mode(AppColors.white, BlendMode.srcIn)),
